...
@Directive({
  selector: '[ultColorPickerTriggerFor]',
  exportAs: 'ultColorPickerTriggerFor',
  host: {
    'class': 'ult-color-picker-trigger-for'
  }
})
export class ColorPickerTriggerForDirective {
  @Input('ultColorPickerTriggerFor')
  ...
  private _getOverlayConfig() {
    return new OverlayConfig({
      ...
      panelClass: 'ult-color-picker-overlay-panel'
    });
  }
