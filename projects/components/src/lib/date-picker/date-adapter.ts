...
export const ULT_DATE_LOCALE = new InjectionToken<{}>('ULT_DATE_LOCALE', {
  providedIn: 'root',
  factory: ULT_DATE_LOCALE_FACTORY,
});

export function ULT_DATE_LOCALE_FACTORY(): {} {
...
export abstract class DateAdapter<D, L = any> {
   ...
   */
  abstract getDayOfWeekNames(style: 'long' | 'short' | 'narrow', firstDayOfWeek: number): string[];
